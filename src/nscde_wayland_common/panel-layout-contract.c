...
static void
parse_layout_entry(const char *key, const char *val,
...
static void
parse_layout_line(char *line, struct nscde_panel_layout_contract *layout)
{
	...
	*eq = '\0';
	parse_layout_entry(line, eq + 1, layout);
}
